...
namespace MidiPlayerTK
{
    ...
    public partial class MidiSynth : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public fluid_voice fluid_synth_alloc_voice_LOCAL(HiSample hiSample, int chan, int _idSession, int key, int vel)
        {
...
#endif
            // No existing voice found, instanciate a new one
            if (voice == null)
            {
            ...
            voice.fluid_voice_init(channel, key, vel);
